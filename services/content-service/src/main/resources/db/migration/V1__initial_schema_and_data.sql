...
CREATE TABLE content.vocabulary_words (
    id               UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    word_iast        VARCHAR NOT NULL,
    word_devanagari  VARCHAR NOT NULL,
    translation_ru   VARCHAR NOT NULL,
    translation_en   VARCHAR NOT NULL,
    gender           VARCHAR NOT NULL,
    stem             VARCHAR NOT NULL,
    root             VARCHAR,
    explanation_ru   VARCHAR NOT NULL,
    explanation_en   VARCHAR NOT NULL,
