...
public interface SessionQuestionToDtoMapper {
    ...
    @Mapping(target = "targetCase", ignore = true)
    @Mapping(target = "targetNumber", ignore = true)
    ...
    @Mapping(target = "questionSourceLanguage", ignore = true)
    @Mapping(target = "questionTargetLanguage", ignore = true)
    ...
    @Mapping(target = "stem", ignore = true)
