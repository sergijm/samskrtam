...
@RestController
@RequestMapping("/api/v1/quiz/declensions/sessions")
@Tag(name = "Declensions Quiz", description = "APIs for declensions quiz sessions")
...
public class DeclensionsSessionController {
    ...
    @PostMapping("/start")
    @Operation(summary = "Start a new declensions quiz session")
    ...
    @Operation(summary = "Resume an existing declensions quiz session")
    ...
    @Operation(summary = "Submit an answer for a question in a declensions quiz session")
    ...
    @Operation(summary = "Complete a declensions quiz session")
