...
export const curriculumTree: CurriculumNode[] = [
    ...
    children: [
      // --- 2.1.1 Nouns (Declension) ---------------------------------
      {
        ...
        children: [
          ...
          { id: '2.1.1.6', titleKey: 'nouns.r_stems', status: 'available', route: '/lessons/grammar/declensions-r' },
          { id: '2.1.1.7', titleKey: 'nouns.cons_an', status: 'planned' },
          { id: '2.1.1.8', titleKey: 'nouns.cons_in_vant_mant', status: 'planned' },
          { id: '2.1.1.9', titleKey: 'nouns.cons_as_is_us', status: 'planned' },
          { id: '2.1.1.10', titleKey: 'nouns.cons_at_ant', status: 'planned' },
          { id: '2.1.1.11', titleKey: 'nouns.cons_simple_final', status: 'planned' },
          { id: '2.1.1.12', titleKey: 'nouns.irregular', status: 'planned' },
        ],
      },
      // --- 2.1.2 Adjectives ------------------------------------------
      {
  ...
  // =========================================================================
  {
    ...
    children: [
      ...
      { id: '2.2.3', titleKey: 'writing.transliteration', status: 'available', route: '/writing/transliteration' },
