...
export const curriculumTree: CurriculumNode[] = [
  // ─── §2.1 Существительные (склонение) ───────────────────────────────
  {
    ...
    children: [
      ...
      { id: '2.1.4', titleKey: 'nouns.i_stems', status: 'available', route: '/lessons/grammar/declensions-i' },
      { id: '2.1.5', titleKey: 'nouns.ii_stems', status: 'available', route: '/lessons/grammar/declensions-ii' },
      { id: '2.1.6', titleKey: 'nouns.u_stems', status: 'available', route: '/lessons/grammar/declensions-u' },
      { id: '2.1.7', titleKey: 'nouns.uu_stems', status: 'available', route: '/lessons/grammar/declensions-uu' },
      { id: '2.1.8', titleKey: 'nouns.r_stems', status: 'available', route: '/lessons/grammar/declensions-r' },
      // Согласные основы
