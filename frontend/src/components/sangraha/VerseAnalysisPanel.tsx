...
export default function VerseAnalysisPanel({
    ...
    const hasAnalysisData = analysis?.translationRu || analysis?.translationEn || (analysis?.sandhiSplits && analysis.sandhiSplits.length > 0);
    const hasWords = words && words.length > 0;
    const analysisIncomplete = !hasAnalysisData || !hasWords;
    ...
    return (
        <div>
            ...
            {analysisIncomplete ? (
                <Message
                    severity="warn"
                    text={t('sangraha.error.analysisIncomplete')}
