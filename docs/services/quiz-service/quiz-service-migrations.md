...
- stem_devanagari (VARCHAR(255), из content-service DeclensionStem.stemDevanagari)
- stem_translation_ru (VARCHAR(255), из content-service DeclensionStem.translationRu)
