...
| content-service | Java 21 | `sm.selflearn.samskrtam.content` | Логика генерации VOCABULARY квизов обновлена для учета иерархии категорий слов и инвариантного к регистру поиска по `slug`. |
