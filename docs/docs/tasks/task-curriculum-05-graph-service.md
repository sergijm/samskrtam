...
- [ ] `wouldCreateCycle` покрыт тестами (прямой цикл, транзитивный цикл через 3+ узла, отсутствие цикла)
- [ ] `computeLayers` покрыт тестами (линейная цепочка, diamond, evergreen исключены, displayOrder tie-break)
