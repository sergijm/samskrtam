...
- Services: CONTENT_SERVICE_URL, USER_SERVICE_URL, DICTIONARY_SERVICE_URL, FEATURE_FLAG_SERVICE_URL, CORS_ALLOWED_ORIGINS
...
Порты: curriculum-service (8081), user-service (8087), dictionary-service (8083), quiz-service (8082), sangraha-service (8089), curriculum-service (8091).